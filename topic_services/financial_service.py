...
import logging
logging.basicConfig(filename='financial_service.log', level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s')
...
SOURCES = [
    ...
    {
        "source_id": "financial:bloomberg-etf-report",
        "source_name": "Bloomberg ETF Report",
        "feed_url": "https://news.google.com/rss/search?q=site%3Abloomberg.com+ETF&hl=en-US&gl=US&ceid=US%3Aen",
        "site_url": "https://www.bloomberg.com/etf/",
    },
]
