...
import logging
logging.basicConfig(filename='metals_service.log', level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s')
...
SOURCES = [
    {
        "source_id": "metals:kitco",
        "source_name": "Kitco",
        "feed_url": "https://news.google.com/rss/search?q=site:kitco.com+gold+silver&hl=en-US&gl=US&ceid=US:en",
        "site_url": "https://www.kitco.com/",
    },
    {
        "source_id": "metals:Mgsrefining",
        "source_name": "Mgsrefining",
        "feed_url": "http://www.mgsrefining.com/feed/",
        "site_url": "http://www.mgsrefining.com/",
    },
]
