...
import logging
logging.basicConfig(filename='geopolitical_service.log', level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s')
...
SOURCES = [
    ...
    {
        "source_id": "geopolitical:geopolitical-watch",
        "source_name": "Geopolitical Watch",
        "feed_url": "https://news.google.com/rss/search?q=geopolitical+watch+analysis&hl=en-US&gl=US&ceid=US:en",
        "site_url": "https://geopoliticalwatch.com/",
    },
    {
        "source_id": "geopolitical:atlantic-council",
        "source_name": "Atlantic Council",
        "feed_url": "https://www.atlanticcouncil.org/feed/",
        "site_url": "https://www.atlanticcouncil.org/",
    },
]
